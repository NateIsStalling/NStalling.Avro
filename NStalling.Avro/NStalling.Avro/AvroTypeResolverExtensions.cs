...
public static class AvroTypeResolverExtensions
{
    ...
    /// </summary>
    public static Type Resolve(this IAvroTypeResolver resolver, Schema schema, Type? declaredType = null, string? schemaVersion = null)
    {
    ...
    /// </summary>
    public static bool TryResolve(this IAvroTypeResolver resolver, Schema schema, Type? declaredType, string? schemaVersion, out Type? type)
    {
        if (resolver is null) throw new ArgumentNullException(nameof(resolver));
        if (schema is not NamedSchema namedSchema)
        {
    ...
    /// </summary>
    public static Type? ResolveOrDefault(this IAvroTypeResolver resolver, Schema schema, Type? declaredType = null, string? schemaVersion = null)
    {
        if (resolver is null) throw new ArgumentNullException(nameof(resolver));
        if (schema is not NamedSchema namedSchema)
        {
